...
export function effectSetupContext(metadata: EffectRuntimeMetadata, start: number, side: EffectBattleSide): EffectSetupContext | undefined {
  ...
  if (metadata.flags !== 0x34e00 || start !== 0x2a30) return undefined;
