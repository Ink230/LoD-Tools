...
export class IrongoonService {
  public optionTooltips: IrongoonTooltip[] = [
    ...
    { option: 'Dragoon Spell Stats', message: `Controls scalar spell metadata: power, MP cost, accuracy, and status chance. Shuffle moves selected values; Randomize Bounds generates values inside the configured bounds; Randomize Random seededly chooses stock, shuffle, or bounds per selected field. In every non-raw mode, the first unlocked spell's MP cost remains comfortable at Dragoon level 1.`, },
      ...
      columns: [
        ...
        },
        {
          ...
          settings: [
            ...
            { id: 15, name: 'Randomize Dragoon Spell MP Cost', value: 2, inputType: IrongoonInputs.Slider, descriptor: 'dragoonSpellRandomizeMpCost' },
