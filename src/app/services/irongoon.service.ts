          ...
          settings: [
            {
              ...
              name: 'Irongoon',
              options: [
                { id: 0, name: 'Irongoon', value: 1, inputType: IrongoonInputs.Slider },
                { id: 1, name: 'Ultimate', value: 1, inputType: IrongoonInputs.Slider },
                { id: 2, name: 'Kaizo', value: 1, inputType: IrongoonInputs.Slider },
                { id: 3, name: '108th', value: 1, inputType: IrongoonInputs.Slider },
              ],
            },
          ],
        },
          ...
          settings: [
            {
              ...
              options: [
                ...
                { id: 3, name: 'Solo', value: 1, inputType: IrongoonInputs.Slider },
                { id: 4, name: 'No Shops', value: 1, inputType: IrongoonInputs.Slider },
                { id: 5, name: 'Randomizer+', value: 1, inputType: IrongoonInputs.Slider },
                { id: 6, name: 'Chaos', value: 1, inputType: IrongoonInputs.Slider },
              ],
            },
          ],
        },
