          ...
          settings: [
            {
              ...
              options: [
                ...
                { id: 4, name: 'Monster Stats Upper % Bound', value: 100, inputType: IrongoonInputs.Number, disabled: false, descriptor: 'test' },
                { id: 5, name: 'Monster Stats Upper % Bound', value: 100, inputType: IrongoonInputs.Number, disabled: false, descriptor: 'test' },
              ],
            },
          ],
        },
